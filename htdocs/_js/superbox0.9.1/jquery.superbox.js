...
;(function($){
	...
	// Local variables
	var $overlay, $wrapper, $container, $superbox, $closeBtn, $loading, $nextprev, $nextBtn, $prevBtn, settings, $innerbox,
	...
	function dispatch(){
		...
		$("a[rel^=superbox],area[rel^=superbox]").each(function(){
			...
			var boxCurrentAttrs = relAttr.split('[')
			if(boxCurrentAttrs[1])
				boxCurrentAttrs = boxCurrentAttrs[1].match(/([#\.][^#\.\]]+)/g) || []
			else
				boxCurrentAttrs = []
		...
		ajax: function($elt, curSettings){
			...
			$elt.click(function(e){
				...
				initLoading(function(){
					...
					PostBack.Post($elt, $innerbox, extraSettings[0], [], 'INSERT', true)
